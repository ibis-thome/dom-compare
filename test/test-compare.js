...
describe('Compare', function () {
   ...
   it('equal documents reports no differences', function() {
      assert.equal(true, compare(
          parser.parseFromString('<html><div /></html>', "text/html"),
          parser.parseFromString('<html><div /></html>', "text/html")
      ).getResult());
   });
   ...
   describe('Documents', function () {
      it('with different root node names are different', function () {
         var doc1 = parser.parseFromString("<doc />", "text/xml");
         var doc2 = parser.parseFromString("<div />", "text/xml");
         assert.equal(false, compare(doc1, doc2).getResult());
      });

      it('with same root node names are same', function () {
         var doc1 = parser.parseFromString("<doc />", "text/xml");
         var doc2 = parser.parseFromString("<doc />", "text/xml");
         assert.equal(true, compare(doc1, doc2).getResult());
      });

      it('with same attribute set but different order are same', function () {
         var doc1 = parser.parseFromString("<doc x='1' a='2' />", "text/xml");
         var doc2 = parser.parseFromString("<doc a='2' x='1' />", "text/xml");
         assert.equal(true, compare(doc1, doc2).getResult());
      });

      it('with different attributes set is different', function () {
         var doc1 = parser.parseFromString("<doc x='1' />", "text/xml");
         var doc2 = parser.parseFromString("<doc a='2' />", "text/xml");
         assert.equal(false, compare(doc1, doc2).getResult());
      });

      it('with same attributes but with different values is different', function () {
         var doc1 = parser.parseFromString("<doc a='1' />", "text/xml");
         var doc2 = parser.parseFromString("<doc a='2' />", "text/xml");
         assert.equal(false, compare(doc1, doc2).getResult());
      });
   });
   ...
   describe('Document fragments', function () {
      it('supported', function () {
         var doc = parser.parseFromString("<doc />", "text/xml");
   ...
   describe('Nodes', function () {
      it('with different names are different', function () {
         var doc1 = parser.parseFromString("<doc><nodeA></doc>", "text/xml");
         var doc2 = parser.parseFromString("<doc><nodeB></doc>", "text/xml");
         assert.equal(false, compare(doc1, doc2).getResult());
      });

      it('with same names are same', function () {
         var doc1 = parser.parseFromString("<doc><nodeA></doc>", "text/xml");
         var doc2 = parser.parseFromString("<doc><nodeA></doc>", "text/xml");
         assert.equal(true, compare(doc1, doc2).getResult());
      });

      it('with same attribute set but different order are same', function () {
         var doc1 = parser.parseFromString("<doc><node x='1' a='2' /></doc>", "text/xml");
         var doc2 = parser.parseFromString("<doc><node a='2' x='1' /></doc>", "text/xml");
         assert.equal(true, compare(doc1, doc2).getResult());
      });

      it('with different attributes set is different', function () {
         var doc1 = parser.parseFromString("<doc><node x='1' /></doc>", "text/xml");
         var doc2 = parser.parseFromString("<doc><node a='2' /></doc>", "text/xml");
         assert.equal(false, compare(doc1, doc2).getResult());
      });

      it('with same attributes but with different values is different', function () {
         var doc1 = parser.parseFromString("<doc><node a='1' /></doc>", "text/xml");
         var doc2 = parser.parseFromString("<doc><node a='2' /></doc>", "text/xml");
         assert.equal(false, compare(doc1, doc2).getResult());
         ...
         describe("spaces matters", function(){
            ...
            it("", function(){
               var doc1 = parser.parseFromString("<doc><node a='1' /></doc>", "text/xml");
               var doc2 = parser.parseFromString("<doc><node a=' 1 ' /></doc>", "text/xml");
               assert.equal(false, compare(doc1, doc2).getResult());
            });

            it("but can be omitted", function(){
               doc1 = parser.parseFromString("<doc><node a='1' /></doc>", "text/xml");
               doc2 = parser.parseFromString("<doc><node a=' 1 ' /></doc>", "text/xml");
   ...
   describe('Node Lists', function () {
      it("order of child nodes matters", function () {
         var doc1 = parser.parseFromString("<doc><nodeA/><nodeB/></doc>", "text/xml");
         var doc2 = parser.parseFromString("<doc><nodeB/><nodeA/></doc>", "text/xml");
         assert.equal(false, compare(doc1, doc2).getResult());
      });

      it("full list of child nodes is compared", function() {
          var doc1 = parser.parseFromString("<doc><nodeA/><nodeB/></doc>", "text/xml");
          var doc2 = parser.parseFromString("<doc><nodeA/><nodeB/><nodeC/><nodeD/></doc>", "text/xml");
          assert.equal(false, compare(doc1, doc2).getResult());
   ...
   describe("Text nodes", function () {
      ...
      describe('Comments', function () {
         it("normally comments are ignored", function () {
            var doc1 = parser.parseFromString("<doc><!-- doc1 --><node><!-- has --></node></doc>", "text/xml");
            var doc2 = parser.parseFromString("<doc><!-- doc2 --><node /></doc>", "text/xml");
            assert.equal(true, compare(doc1, doc2).getResult());

            doc1 = parser.parseFromString("<doc><!-- doc1 --></doc>", "text/xml");
            doc2 = parser.parseFromString("<doc><!-- doc2 --></doc>", "text/xml");
            assert.equal(true, compare(doc1, doc2).getResult());
         });

         it("when `compareComments` options is set - comments are compared too", function () {
            var doc1 = parser.parseFromString("<doc><!-- doc1 --></doc>", "text/xml");
            var doc2 = parser.parseFromString("<doc><!-- doc2 --></doc>", "text/xml");
            assert.equal(false, compare(doc1, doc2, { compareComments: true }).getResult());

            doc1 = parser.parseFromString("<doc><!-- doc1 --></doc>", "text/xml");
            doc2 = parser.parseFromString("<doc><!-- doc1 --></doc>", "text/xml");
            assert.equal(true, compare(doc1, doc2, { compareComments: true }).getResult());

            doc1 = parser.parseFromString("<doc><!-- doc1 --><node><!-- has --></node></doc>", "text/xml");
            doc2 = parser.parseFromString("<doc><!-- doc2 --><node /></doc>", "text/xml");
            assert.equal(false, compare(doc1, doc2, { compareComments: true }).getResult());
         });
         ...
         describe("Extra whitespace stripping", function () {
            it("normally all whitespaces at the beginning/end are preserved", function () {
               var doc1 = parser.parseFromString("<doc><!--doc1--></doc>", "text/xml");
               var doc2 = parser.parseFromString("<doc><!--doc1--></doc>", "text/xml");
               assert.equal(true, compare(doc1, doc2, { compareComments: true }).getResult());
      ...
      describe("Text", function () {
         it("compared by default with all whitespaces", function () {
            var doc1 = parser.parseFromString("<doc><node>A</node>B</doc>", "text/xml");
            var doc2 = parser.parseFromString("<doc><node>A</node>B</doc>", "text/xml");
            assert.equal(true, compare(doc1, doc2).getResult());

            doc1 = parser.parseFromString("<doc><node>A</node>B</doc>", "text/xml");
            doc2 = parser.parseFromString("<doc><node>A</node> B</doc>", "text/xml");
            assert.equal(false, compare(doc1, doc2).getResult());

            doc1 = parser.parseFromString("<doc>B<node>A</node></doc>", "text/xml");
            doc2 = parser.parseFromString("<doc><node>A</node>B</doc>", "text/xml");
            assert.equal(false, compare(doc1, doc2).getResult());

            doc1 = parser.parseFromString("<doc><node>A</node></doc>", "text/xml");
            doc2 = parser.parseFromString("<doc><node> A </node></doc>", "text/xml");
            assert.equal(false, compare(doc1, doc2).getResult());
         });

         it("empty text nodes are always ignored", function(){

            var doc1 = parser.parseFromString("<doc>    <node /><b />    </doc>", "text/xml");
            var doc2 = parser.parseFromString("<doc><node />     <b /></doc>", "text/xml");
            assert.equal(true, compare(doc1, doc2).getResult());

         });

         it("set `stripSpaces` option to get rid of them", function () {
            var doc1 = parser.parseFromString("<doc><node>A</node></doc>", "text/xml");
            var doc2 = parser.parseFromString("<doc><node> A </node></doc>", "text/xml");
            assert.equal(true, compare(doc1, doc2, { stripSpaces: true }).getResult());
         });

         it("set `collapseSpaces` option to collapse them", function () {
            var doc1 = parser.parseFromString("<doc><node> A \n\r\t B </node></doc>", "text/xml");
            var doc2 = parser.parseFromString("<doc><node> A \t\n\r B </node></doc>", "text/xml");
            assert.equal(true, compare(doc1, doc2, { collapseSpaces: true }).getResult());

            doc1 = parser.parseFromString("<doc><node> \n\r\t A  B </node></doc>", "text/xml");
      ...
      describe("CDATA", function () {
         it("compared as text nodes but `stripSpaces` and `collapseSpaces` are not respected", function () {
            var doc1 = parser.parseFromString("<doc><![CDATA[data-data-data]]></doc>", "text/xml");
            var doc2 = parser.parseFromString("<doc><![CDATA[data-data-data]]></doc>", "text/xml");
            assert.equal(true, compare(doc1, doc2).getResult());

            doc1 = parser.parseFromString("<doc><![CDATA[data-data-data]]></doc>", "text/xml");
            doc2 = parser.parseFromString("<doc><![CDATA[data -data-data]]></doc>", "text/xml");
            assert.equal(false, compare(doc1, doc2).getResult());
...
<anotherelement>
 <message>Hiyo</message>
          ...
          var doc1 = parser.parseFromString(str1, "text/html");
          var doc2 = parser.parseFromString(str2, "text/html");
          assert.equal(false, compare(doc1, doc2).getResult());
